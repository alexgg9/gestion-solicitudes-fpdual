                        ...
                        <div class="row mb-4">
                            <div class="col-md-6">
                                <div class="mb-3">
                                    ...
                                    <p class="form-control-static">{{ $solicitud->nombre_empresa }}</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">NIF:</label>
                                    <p class="form-control-static">{{ $solicitud->nif }}</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Actividad de la Empresa:</label>
                                    <p class="form-control-static">{{ $solicitud->actividad_empresa }}</p>
                                </div>
                            </div>
                            <div class="col-md-6">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Modalidad:</label>
                                    <p class="form-control-static">{{ $solicitud->modalidad }}</p>
                                </div>
                                <div class="mb-3">
                                    <label class="form-label fw-bold">Observaciones:</label>
                                    <p class="form-control-static">{{ $solicitud->observaciones }}</p>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="row">
                            <div class="col-md-4">
                                <div class="mb-3">
                                    ...
                                    <p class="form-control-static">{{ $solicitud->smr_1 }}</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">SMR 2º:</label>
                                    <p class="form-control-static">{{ $solicitud->smr_2 }}</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">DAM 1º:</label>
                                    <p class="form-control-static">{{ $solicitud->dam_1 }}</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">DAM 2º:</label>
                                    <p class="form-control-static">{{ $solicitud->dam_2 }}</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">DAW 1º:</label>
                                    <p class="form-control-static">{{ $solicitud->daw_1 }}</p>
                                </div>
                            </div>
                            <div class="col-md-4">
                                <div class="mb-3">
                                    <label class="form-label fw-bold">DAW 2º:</label>
                                    <p class="form-control-static">{{ $solicitud->daw_2 }}</p>
                                </div>
                            </div>
                        </div>
