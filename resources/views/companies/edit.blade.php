                        ...
                        <form action="{{ route('companies.update', $company->id) }}" method="POST">
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="province" id="province" class="form-control"
                                    value="{{ $company->province }}" required>
                            </div>
                            <!-- Postal Code -->
                            <div class="form-group mb-3">
                                <label for="postal_code">Postal Code</label>
                                <input type="text" name="postal_code" id="postal_code" class="form-control"
                                    value="{{ $company->postal_code }}" required>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <input type="text" name="manager_name" id="manager_name" class="form-control"
                                    value="{{ $company->manager_name }}" required>
                            </div>

                            <!-- Manager DNI -->
                            <div class="form-group mb-3">
                                <label for="manager_dni">Manager DNI</label>
                                <input type="text" name="manager_dni" id="manager_dni" class="form-control"
                                    value="{{ $company->manager_dni }}" required>
                            </div>
                            ...
                            <div class="form-group mb-3">
                                ...
                                <select name="modality" id="modality" class="form-control" required>
                                    <option value="Presencial" {{ $company->modality == 'Presencial' ? 'selected' : '' }}>
                                        Presencial</option>
                                    <option value="Remoto" {{ $company->modality == 'Remoto' ? 'selected' : '' }}>Remoto
                                    </option>
                                    <option value="Híbrido" {{ $company->modality == 'Híbrido' ? 'selected' : '' }}>Híbrido
                                    </option>
                                </select>
                            </div>
